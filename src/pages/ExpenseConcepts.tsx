    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="h-9 w-full rounded-md border border-line bg-panel pl-9 pr-3 text-sm focus:border-accent-deep focus:outline-none sm:w-96"
        />
      </div>
                ...
                >
                  ...
                  <td data-label="Estado" className="px-3 py-1">
                    <button
                      ...
                      disabled={busy}
                      className={cn(
                        'rounded px-1.5 py-0.5 text-[12px] font-semibold uppercase tracking-[0.06em] transition-colors',
                        concept.active
